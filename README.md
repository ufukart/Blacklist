...
| Metric | Value |
| --------- | ------: |
| **Blocked IP Addresses** | **<!--IP_COUNT-->242273<!--/IP_COUNT-->** |
...
> 🔥 The blacklist currently contains **<!--IP_COUNT-->242273<!--/IP_COUNT-->** unique malicious IP addresses, aggregated from 11 trusted security feeds and refreshed every 6 hours.
...
- **Total IPs**: **<!--IP_COUNT-->242273<!--/IP_COUNT-->** (varies with updates)
- **Update Frequency**: Every 6 hours
